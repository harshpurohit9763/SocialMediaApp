...
class MinePosts extends StatelessWidget {
  MinePosts({super.key});
      ...
      return homeController.loading.value
          ...
          : Container(
              ...
              child: GridView.builder(
                ...
                itemCount: homeController.userPostList.length,
                itemBuilder: (BuildContext context, int index) {
                  Post post = homeController.userPostList[index];
                  ...
                  return Padding(
                    ...
                    child: Container(
                      ...
                      child: GestureDetector(
                        onTap: () {
                          Get.to(
                            PostDetailedView( userinfo: homeController.user.value,post: post),
                            arguments: post.url,
                          );
                        },
